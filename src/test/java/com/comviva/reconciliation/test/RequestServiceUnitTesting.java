...
public class RequestServiceUnitTesting {
		...
		ResponseEntity<StatusCheckResponse> successStatusResponseEntity = new ResponseEntity<StatusCheckResponse>(successStatus, HttpStatus.valueOf(200));
		ResponseEntity<StatusCheckResponse> failureStatusResponseEntity = new ResponseEntity<StatusCheckResponse>(failedStatus, HttpStatus.valueOf(200));
		
		ResponseEntity<ReversalResponse> successResponseEntity = new ResponseEntity<ReversalResponse>(successfulReversal, HttpStatus.valueOf(200));
		ResponseEntity<ReversalResponse> failureResponseEntity = new ResponseEntity<ReversalResponse>(failedReversal, HttpStatus.valueOf(404));
		...
		public void sendReversalRequest_Failure(){
			Mockito.when(restTemplate.postForEntity("http://localhost:8090/reversal",
					getReversalRequest(transaction), ReversalResponse.class)).thenReturn(failureResponseEntity);
